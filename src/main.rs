...
mod tests {
    ...
    #[test]
    fn test_md5() {
        assert_eq!("9e107d9d372bb6826bd81d3542a419d6", MD5::encode("The quick brown fox jumps over the lazy dog"));
        assert_eq!("e4d909c290d0fb1ca068ffaddf22cbd0", MD5::encode("The quick brown fox jumps over the lazy dog."));
    }
}
